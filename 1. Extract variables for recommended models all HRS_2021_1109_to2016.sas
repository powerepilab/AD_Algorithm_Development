libname rand 'F:\power\HRS\RAND_HRS\sasdata\2018(V1)';
options fmtsearch = (rand.formats);
libname raw 'F:\power\HRS\HRS data (raw)\SAS datasets';

/**********************************************************************************************************************
*
*	Created 2019_0308, Updated 2019_0508, 2019_1202, 2020_0804, 2021_1109 
...
*
*		--> 2018 is currently unavailable due to missing sampling weights and RAND version of self-cognition 
*
*
...
data base; set rand.randhrs1992_2018v1 (keep = hhid pn raestrat raehsamp /*cluster & strata variables*/
									 hacohort ragender 
...
%soc(08) %soc(10) %soc(12) %soc(14) %soc(16) 
...
%macro ch(v);
	...
	/*2008 (w9)*/
 	...
 	/*2014 (w12)*/
		...
		label &v.ch_14 = "change in &v between last non-missing interview and 2016 (non-standardized, no lookback limit)";

	proc means nolabels; var &v.ch_98 &v.ch_00 &v.ch_02 &v.ch_04 &v.ch_06 &v.ch_08 &v.ch_10 &v.ch_12 &v.ch_14 &v.ch_16;
...
run;
%mend;
%ch(16, 14) %ch(14, 12) %ch(12, 10) %ch(10, 08) %ch(08, 06) %ch(06, 04) %ch(04, 02) %ch(02, 00)
%ch(00, 98) %ch(98, 96)
...
var proxy_12 proxy_14 proxy_16 IQCODE_12 IQCODE_14 IQCODE_16;
run;

%macro imp(var);
data base; set base;
	array prior[*] &var._94 &var._96 &var._98 &var._00 &var._02 &var._04 &var._06 &var._08 &var._10 &var._12 &var._14 ;
	array var[*] &var._96 &var._98 &var._00 &var._02 &var._04 &var._06 &var._08 &var._10 &var._12 &var._14 &var._16 ;
	array imp[*] &var._i_96 &var._i_98 &var._i_00 &var._i_02 &var._i_04 &var._i_06 &var._i_08 &var._i_10 &var._i_12 &var._i_14 &var._i_16 ;
	array flag[*] &var._if_96 &var._if_98 &var._if_00 &var._if_02 &var._if_04 &var._if_06 &var._if_08 &var._if_10 &var._if_12 &var._if_14 &var._if_16 ;
	array proxy[*] proxy_96 proxy_98 proxy_00 proxy_02 proxy_04 proxy_06 proxy_08 proxy_10 proxy_12 proxy_14 proxy_16 ;
	...
	*for 1994 wave (where there is no prior wave), set imputed version equal to non-imputed version for all;
	...
	proc means nolabels;
		var &var._94 &var._i_94 &var._96 &var._i_96 &var._if_96 &var._98 &var._i_98 &var._if_98 &var._00 &var._i_00 &var._if_00 &var._02 &var._i_02 &var._if_02 
			...
			&var._12 &var._i_12 &var._if_12 &var._14 &var._i_14 &var._if_14 &var._16 &var._i_16 &var._if_16 ;
run;
%mend;
...
run;
%mend;
%lab(96) %lab(98) %lab(00) %lab(02) %lab(04) %lab(06) %lab(08) %lab(10) %lab(12) %lab(14) %lab(16) 
...
%mend;
%lab(98) %lab(00) %lab(02) %lab(04) %lab(06) %lab(08) %lab(10) %lab(12) %lab(14) %lab(16) 
...
%macro int(y);
	...
	run;
%mend;
%int(98)%int(00)%int(02)%int(04)%int(06)%int(08)%int(10)%int(12)%int(14)%int(16)
...
%wave(08)%wave(10)%wave(12)%wave(14)%wave(16)
